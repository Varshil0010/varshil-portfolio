  ...
  return (
    <div name="contact" className='w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
      <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
        <div className='pb-8'>
            <p className='text-4xl font-bold inline border-b-4 border-gray-500'>Let's discuss</p>
            <p className='py-6'>Get in touch. Always available for coding if the right project comes along with me.</p>
        </div>

        <div className='flex justify-center items-center'>
            <form action='https://getform.io/f/6a87868f-48c8-4c05-abf2-eb68a4591d04' method='POST' className='flex flex-col w-full md:w-1/2'>
